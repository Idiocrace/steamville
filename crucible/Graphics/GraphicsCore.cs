...
namespace Crucible.Graphics
{
    ...
    public class GraphicsCore : IDisposable
    {
        ...
        public _GameState CurrentState { get; private set; } = _GameState.MainMenu;
        ...
        public void SetState(_GameState state, string? title = null)
        {
            CurrentState = state;
        ...
        {
            if (CurrentState == _GameState.MainMenu)
